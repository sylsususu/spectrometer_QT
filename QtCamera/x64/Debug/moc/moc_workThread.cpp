...
QT_MOC_LITERAL(1, 11, 6), // "getMat"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "cv::Mat"
QT_MOC_LITERAL(4, 27, 3) // "mat"

    },
    "workThread\0getMat\0\0cv::Mat\0mat"
};
...
void workThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getMat((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&workThread::getMat)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void workThread::getMat(cv::Mat _t1)
{
